...
### [ncclResult_t](types.md#c.ncclResult_t) ncclRedOpCreatePreMulSum([ncclRedOp_t](types.md#c.ncclRedOp_t) \*op, void \*scalar, [ncclDataType_t](types.md#c.ncclDataType_t) datatype, [ncclScalarResidence_t](types.md#c.ncclScalarResidence_t) residence, [ncclComm_t](types.md#c.ncclComm_t) comm)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclRedOpDestroy([ncclRedOp_t](types.md#c.ncclRedOp_t) op, [ncclComm_t](types.md#c.ncclComm_t) comm)
