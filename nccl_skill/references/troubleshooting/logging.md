...
|----------------------------------------------------------------------|--------------------------------------------|
| [NCCL_DEBUG](../env.md#nccl-debug)                                   | Sets verbosity: VERSION, WARN, INFO, TRACE |
| [NCCL_DEBUG_SUBSYS](../env.md#nccl-debug-subsys)                     | Filters log output by subsystem            |
| [NCCL_DEBUG_FILE](../env.md#nccl-debug-file)                         | Writes logs to files (%h host, %p PID)     |
| [NCCL_DEBUG_TIMESTAMP_FORMAT](../env.md#nccl-debug-timestamp-format) | Sets timestamp format (strftime syntax)    |
| [NCCL_DEBUG_TIMESTAMP_LEVELS](../env.md#nccl-debug-timestamp-levels) | Selects which levels include timestamps    |
...
| DESTROY     | Communicator destroy, abort, revoke, and plugin unload/close<br/>operations |
| ALL         | All subsystems                                                              |
