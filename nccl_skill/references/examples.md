...
checkTimeout() should be a user-defined function. For more nonblocking communicator usage, please check [Fault Tolerance](usage/communicators.md#ft).
In addition, if you want to split communicators instead of creating a new one, please check [`ncclCommSplit()`](api/comms.md#c.ncclCommSplit).
