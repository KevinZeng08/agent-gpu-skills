...
- **Handle-based**: look up a parameter by key once and bind it to a [`ncclParamHandle_t`](#c.ncclParamHandle_t)
  handle with [`ncclParamBind()`](#c.ncclParamBind), then read typed values through the returned
  handle.
...
parameter. It is created by [`ncclParamBind()`](#c.ncclParamBind). The handle remains valid for
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclParamBind([ncclParamHandle_t](#c.ncclParamHandle_t) \*out, const char \*key)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetI8([ncclParamHandle_t](#c.ncclParamHandle_t) h, int8_t \*out)

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetI16([ncclParamHandle_t](#c.ncclParamHandle_t) h, int16_t \*out)

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetI32([ncclParamHandle_t](#c.ncclParamHandle_t) h, int32_t \*out)

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetI64([ncclParamHandle_t](#c.ncclParamHandle_t) h, int64_t \*out)

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetU8([ncclParamHandle_t](#c.ncclParamHandle_t) h, uint8_t \*out)

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetU16([ncclParamHandle_t](#c.ncclParamHandle_t) h, uint16_t \*out)

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetU32([ncclParamHandle_t](#c.ncclParamHandle_t) h, uint32_t \*out)

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetU64([ncclParamHandle_t](#c.ncclParamHandle_t) h, uint64_t \*out)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetStr([ncclParamHandle_t](#c.ncclParamHandle_t) h, const char \*\*out)
...
next call to [`ncclParamGetStr()`](#c.ncclParamGetStr) on the same thread. Callers that need
to retain the value across calls must copy it.

### ncclParamGet

### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGet([ncclParamHandle_t](#c.ncclParamHandle_t) h, void \*out, int maxLen, int \*len)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetParameter(const char \*key, const char \*\*value, int \*valueLen)
...
[`ncclParamGetParameter()`](#c.ncclParamGetParameter) on the same thread. *valueLen* receives the
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclParamGetAllParameterKeys(const char \*\*\*table, int \*tableLen)
...
[`ncclParamGetAllParameterKeys()`](#c.ncclParamGetAllParameterKeys) on the same thread. The keys in the returned
table are not sorted.

This function returns parameters published in [Environment Variables](../env.md) by default. Setting
