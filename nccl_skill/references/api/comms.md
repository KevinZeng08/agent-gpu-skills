...
### const char \*ncclGetLastError([ncclComm_t](types.md#c.ncclComm_t) comm)
...
### const char \*ncclGetErrorString([ncclResult_t](types.md#c.ncclResult_t) result)

Returns a human-readable string corresponding to the passed error code.

## ncclGetVersion

### [ncclResult_t](types.md#c.ncclResult_t) ncclGetVersion(int \*version)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclGetUniqueId(ncclUniqueId \*uniqueId)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommInitRank([ncclComm_t](types.md#c.ncclComm_t) \*comm, int nranks, ncclUniqueId commId, int rank)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommInitAll([ncclComm_t](types.md#c.ncclComm_t) \*comms, int ndev, const int \*devlist)
...
*comms* should be pre-allocated with size at least ndev\*sizeof([`ncclComm_t`](types.md#c.ncclComm_t)).
...
<a id="ncclcomminitrankconfig"></a>

## ncclCommInitRankConfig

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommInitRankConfig([ncclComm_t](types.md#c.ncclComm_t) \*comm, int nranks, ncclUniqueId commId, int rank, [ncclConfig_t](types.md#c.ncclConfig_t) \*config)
...
See the [Creating a communicator with options](../usage/communicators.md#init-rank-config) section for details on configuration options.

## ncclCommInitRankScalable

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommInitRankScalable([ncclComm_t](types.md#c.ncclComm_t) \*newcomm, int nranks, int myrank, int nId, ncclUniqueId \*commIds, [ncclConfig_t](types.md#c.ncclConfig_t) \*config)
...
See the [Creating a communicator with options](../usage/communicators.md#init-rank-config) section for details on how to create and distribute the list of ncclUniqueIds.

## ncclCommSplit

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommSplit([ncclComm_t](types.md#c.ncclComm_t) comm, int color, int key, [ncclComm_t](types.md#c.ncclComm_t) \*newcomm, [ncclConfig_t](types.md#c.ncclConfig_t) \*config)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommShrink([ncclComm_t](types.md#c.ncclComm_t) comm, int \*excludeRanksList, int excludeRanksCount, [ncclComm_t](types.md#c.ncclComm_t) \*newcomm, [ncclConfig_t](types.md#c.ncclConfig_t) \*config, int shrinkFlags)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommGetUniqueId([ncclComm_t](types.md#c.ncclComm_t) comm, ncclUniqueId \*uniqueId)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommGrow([ncclComm_t](types.md#c.ncclComm_t) comm, int nRanks, const ncclUniqueId \*uniqueId, int rank, [ncclComm_t](types.md#c.ncclComm_t) \*newcomm, [ncclConfig_t](types.md#c.ncclConfig_t) \*config)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommRevoke([ncclComm_t](types.md#c.ncclComm_t) comm, int revokeFlags)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommFinalize([ncclComm_t](types.md#c.ncclComm_t) comm)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommDestroy([ncclComm_t](types.md#c.ncclComm_t) comm)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommAbort([ncclComm_t](types.md#c.ncclComm_t) comm)
...
abort the NCCL communicator successfully. For more use cases, please check [Fault Tolerance](../usage/communicators.md#ft).

## ncclCommGetAsyncError

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommGetAsyncError([ncclComm_t](types.md#c.ncclComm_t) comm, [ncclResult_t](types.md#c.ncclResult_t) \*asyncError)
...
If there has been an error on the communicator, user should destroy the communicator with [`ncclCommAbort()`](#c.ncclCommAbort).
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommCount(const [ncclComm_t](types.md#c.ncclComm_t) comm, int \*count)

Returns in *count* the number of ranks in the NCCL communicator *comm*.

## ncclCommCuDevice

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommCuDevice(const [ncclComm_t](types.md#c.ncclComm_t) comm, int \*device)

Returns in *device* the CUDA device associated with the NCCL communicator *comm*.

## ncclCommUserRank

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommUserRank(const [ncclComm_t](types.md#c.ncclComm_t) comm, int \*rank)

Returns in *rank* the rank of the caller in the NCCL communicator *comm*.

## ncclCommRegister

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommRegister(const [ncclComm_t](types.md#c.ncclComm_t) comm, void \*buff, size_t size, void \*\*handle)

Registers the buffer *buff* with *size* under communicator *comm* for zero-copy communication; *handle* is
returned for future deregistration. See *buff* and *size* requirements and more instructions in [User Buffer Registration](../usage/bufferreg.md#user-buffer-reg).

## ncclCommDeregister

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommDeregister(const [ncclComm_t](types.md#c.ncclComm_t) comm, void \*handle)

Deregister buffer represented by *handle* under communicator *comm*.

## ncclCommWindowRegister

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommWindowRegister([ncclComm_t](types.md#c.ncclComm_t) comm, void \*buff, size_t size, [ncclWindow_t](types.md#c.ncclWindow_t) \*win, int winFlags)
...
See *buff* requirement and more instructions in [User Buffer Registration](../usage/bufferreg.md#user-buffer-reg). User can also pass
different win flags to control the registration behavior. For more win flags information, please refer to [Window Registration Flags](flags.md#win-flags).
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommWindowDeregister([ncclComm_t](types.md#c.ncclComm_t) comm, [ncclWindow_t](types.md#c.ncclWindow_t) win)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclMemAlloc(void \*\*ptr, size_t size)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclMemFree(void \*ptr)

Free memory allocated by *ncclMemAlloc()*.

## ncclCommSuspend

### [ncclResult_t](types.md#c.ncclResult_t) ncclCommSuspend([ncclComm_t](types.md#c.ncclComm_t) comm, int flags)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommResume([ncclComm_t](types.md#c.ncclComm_t) comm)
...
### [ncclResult_t](types.md#c.ncclResult_t) ncclCommMemStats([ncclComm_t](types.md#c.ncclComm_t) comm, [ncclCommMemStat_t](types.md#c.ncclCommMemStat_t) stat, uint64_t \*value)

Query communicator memory statistics. The *stat* parameter selects which statistic to retrieve, and the
result is written to  *\*value*. See [`ncclCommMemStat_t`](types.md#c.ncclCommMemStat_t) for the list of available statistics.
